...
\setlength{\parskip}{0pt}    % 段落间距，于具体内容进行动态调整
...
\newcommand\sectionID[1]{第\CJKnumber{#1}章}
...
\titleformat{\chapter}[hang]{\normalfont\sSanhao\filcenter\heiti\bf}%大标题三号黑
{\sSanhao{\chaptertitlename}}{20pt}{\sSanhao}
\titleformat{\section}[hang]{\heiti \bf \sSihao} %小标题四号黑
{\sSihao \thesection}{0.5em}{}{}
\titleformat{\subsection}[hang]{\heiti \bf \sXiaosi}%
{\sXiaosi \thesubsection}{0.5em}{}{}
% \titleformat{\subsubsection}[hang]{\heiti \bf}%
...
\addtolength{\topmargin}{-0.2cm}        %仍需调整
...
\chead{\sSanhao\raisebox{0.04cm}%
    {\fNWPU 西北工业大学} \songti{{\textbf{本科毕业设计（论文）}}}}
%------------------------------------------------------------------------------%
