...
\usepackage{CJKnumb}
% 使用Sim字体
\newcommand\Sog{SimSun}
\newcommand\Hei{SimHei}
\newcommand\Kai{KaiTi}
\newcommand\Fag{FangSong}
...
% 设置字体族
\setCJKfamilyfont{song}{\Sog}      % 宋体
\setCJKfamilyfont{hei}{\Hei}       % 黑体
\setCJKfamilyfont{kai}{\Kai}       % 楷体
\setCJKfamilyfont{fang}{\Fag}      % 仿宋体
...
\titleformat{\chapter}[hang]{\normalfont\sSanhao\filcenter\fHei\bf}%大标题三号黑
{\sSanhao{\chaptertitlename}}{20pt}{\sSanhao}
\titleformat{\section}[hang]{\fHei \bf \sSihao} %小标题四号黑
...
\addtolength{\topmargin}{-0.5cm}        %仍需调整
